...
//
//   @override
//   State<Effects> createState() => _ExampleInstagramFilterSelectionState();
// }
//
// class _ExampleInstagramFilterSelectionState extends State<Effects> {
//   ScreenshotController screenshotController = ScreenshotController();
//   File? imageTemp;
//   Future saveToGallery(BuildContext context) async{
//     {
//       // final imageFilter = await screenshotController.captureFromWidget(_buildPhotoWithFilter());
//       // if (imageFilter == null) return;
//       //
//       // File? imageTemp = File(imageFilter.path);
//       // // imageTemp = await cropimage(imagefile: imageTemp);
//       //
//       // setState(() => this.imageFilter = imageTemp);
...
//     var image = await ImageGallerySaver.saveImage(bytes, name: name);
